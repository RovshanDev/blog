    ...
    <section class="single-post-content">
        <div class="container">
            <div class="row">
                ...
                $sql = "SELECT blog.title,blog.description,blog.created_at,blog.image,categories.title as name FROM  blog LEFT JOIN categories ON blog.cat_id = categories.id WHERE blog.id=$id";
                ...
                <div class="col-md-3">
                    ...
                    <div class="aside-block">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <?php
                            $sql = "SELECT blog.id, blog.title,blog.description,blog.created_at,blog.image,blog.is_monset,blog.status,categories.title as name FROM  blog LEFT JOIN categories ON blog.cat_id = categories.id  WHERE blog.is_monset=0 and blog.status=1 ORDER BY created_at DESC limit 5  ";
                            $query = $database->db->query($sql);
                            $row = $query->fetch_array();
                                ?>
